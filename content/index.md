...
#### Asteria
Asteria is an earth-like world though its size is not much different from Luna(That's our moon!). Despite the difference in size, gravity is only slightly lower than Earth, and you would likely not even notice a difference should you be isekai'd. Physics also tends to behave the same, except when it doesn't because of fun things we don't have. Like magic. 
...
##### The Order
While being a member of The Order requires you to be a Dragonkin, they do allow other ancestries to reside in their cities. They control most of Meklen, where the Great Tree they revere resides. 
##### Jidar Unity
...
#### Magic & Spellcasting
Mechanically, we will be using Pathfinder's rules for all things because major tweaks is extra learning.
That said, here are some brief examples of how some supernatural and extraordinary powers and abilities function within the setting. It is up to you to rationalize how your character's mechanics fit within the world. This list is not exhaustive. If you have ideas, I'm ready to hear them. 

- The magic of the universe comes largely from a mystical force called Aether. Some can tap into this as an energy source for spells. Typically, only Spirits and Seraphim and god-like beings can do this, but on Asteria, Serrans are naturally capable of collecting and converting Aether into energy. Additionally, most on Asteria are capable of learning special summoning rituals which can summon a spirit to cast the spell you desire, before returning from whence they came. Spirits are typically not visible so to most people, this process looks just like the character is casting the spell directly. Those with supernatural sight could use this to determine who is and isn't a Serran, however.

- It is also possible, though rare, to have a Spirit directly bound to you. These spirits remain in the realm, using your body as an anchor and conduit for their magical powers and are typically called Seraphim. Spirits that do this are typically capable of more direct communication with people, and can talk directly through their vessel with the vessels permission.

- Advanced technology exists all over Asteria, hidden in ruins deep underground, or already claimed by the Norsk Empire. This technology is sufficiently advanced that it can be hard to distinguish from magic.

- There are currently no known cases of psionic powers. That doesn't mean they don't exist, however.

- Mana, a corrupted version of Aether, has a randomizing and chaotic effect on the world when it interacts with things. It is also the source of Shadowforged. Rarely, some people have gained the ability to interact with Mana, or have been touched my it, granting them some kind of supernatural or extraordinary abilities. It can be highly dangerous to manipulate mana.
...
As part of their culture as wardens of the Great Tree, there are those who have the ability to shapeshift to mimic the appearance of other humanoid ancestries. The change is often cosmetic but those who lean further into the ability can do more. Their Draconic features often remain in part during these imperfect transformations, but can usually be passed as halfling traits.

Dragonkin are fiercely loyal to the World Tree, and find it very difficult to not lay down their lives in service of it. This loyalty is ingrained into their very genes, making it extremely hard to resist. 
